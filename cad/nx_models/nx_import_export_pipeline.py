...
LPAS_NX_ASSEMBLY = [
    NXComponent("chassis_body",      "chassis/LPAS-STRUCT-010.prt",   "chassis_body.step",      45.0, desc="Al-7075 HC primary structure"),
    NXComponent("wheel_assembly",    "wheels/LPAS-WHEEL-001.prt",     "wheel_assembly.step",     2.5, desc="Ti mesh wheel + hub + motor"),
    ...
    NXComponent("solar_array_panel", "power/LPAS-SOLAR-001.prt",      "solar_array_panel.step",  4.0, desc="GaAs triple-junction, 1m×0.6m"),
    NXComponent("electronics_bay",   "avionics/LPAS-EBOX-040.prt",    "electronics_bay.step",    5.0),
    NXComponent("drill_mechanism",   "science/LPAS-DRILL-001.prt",    "drill_mechanism.step",    8.5, desc="TRIDENT-inspired 0-1m drill"),
    ...
    NXComponent("hga_dish",          "comms/LPAS-HGA-DISH.prt",       "hga_dish.step",           1.2, desc="0.5m Ka-band parabolic"),
